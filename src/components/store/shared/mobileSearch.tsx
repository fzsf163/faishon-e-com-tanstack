...
export default function SearchWithModal() {
  ...
  return (
    <>
      <button
        className='inline-flex h-9 w-fit rounded-lg border border-input bg-background/85 dark:bg-background/40 px-3 py-2 text-sm text-foreground shadow-xs shadow-black/5 transition-shadow placeholder:text-muted-foreground/70 focus-visible:border-ring focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:ring-ring/20 '
